...
from app.db import models  # noqa: E402,F401  (import registers all ORM models on Base.metadata)
...
# value in alembic.ini, so `FINOPS_DATABASE_URL` is the single source of truth.
